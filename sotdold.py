...
fullQuery = "SELECT key, fullname, year, creator, product, publisher, os, vidheight, vidwidth, timesused FROM scrnsvrotd WHERE active=1 AND used=0 AND key = 'bugs' ORDER BY RANDOM()"
